...
class FloatLaravel extends React.Component {
    ...
    moveY() { 
      ...
      render() {
          return (
            ...
            axis="y"
            handle=".handle"
            defaultPosition={{x: 0, y: -window.innerHeight}}
            ...
            onStop={this.handleStop}>
              ...
              <div className="handle" style={{color: 'white'}}>
                  <img src="./langIcons/laravel.svg" height={200} width={150}/>
                </div>
